...
class Keyword extends Base
{
    ...
    public function index()
    {
        ...
        $this->assign('action_link', array('text' => '添加搜索词', 'href' => '/admin/keyword/editKeyword'));
        return $this->display();
    }
    ...
    public function saveKeyword()
    {
        ...
        return $this->url_redirect($result, "/admin/keyword/index", "搜索词列表");
    ...
    public function deleteKeyword()
    {
        ...
        if($result == 1){
            return $this->url_redirect('删除成功', "/admin/keyword/index", "搜索词列表");
        }else{
            return $this->url_redirect('删除失败', "/admin/keyword/index", "搜索词列表");
        }
